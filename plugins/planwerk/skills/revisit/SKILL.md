...
allowed-tools: AskUserQuestion Read Grep Glob Write Bash(gh auth status) Bash(gh repo view:*) Bash(gh issue view:*) Bash(gh issue edit:*) Bash(gh issue comment:*) Bash(gh api:*) Bash(gh pr view:*) Bash(gh pr diff:*) Bash(git fetch:*) Bash(git status:*) Bash(git log:*) Bash(git show:*) Bash(wc:*)
---

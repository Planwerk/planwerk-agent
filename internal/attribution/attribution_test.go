...
func TestAssistantWith_NamesResolvedModel(t *testing.T) {
	if got, want := AssistantWith("claude-opus-5-5"), "with Claude:claude-opus-5-5"; got != want {
		t.Errorf("AssistantWith() = %q, want %q", got, want)
	}
}

func TestAssistantWith_TrimsWhitespace(t *testing.T) {
	if got, want := AssistantWith("  claude-fable-5-1  "), "with Claude:claude-fable-5-1"; got != want {
...
func TestAssistantMarker_IsPrefixOfNamedClause(t *testing.T) {
	...
	if got := AssistantWith("claude-opus-5-5"); got[:len(assistantMarker)] != assistantMarker {
...
func TestCommentFooter_RendersLeadToolCommandAndModel(t *testing.T) {
	resetVersion(t)
	SetVersion("e1efd0d")
	got := CommentFooter("Fix report generated by", "fix", "claude-opus-5-5")
	want := "_Fix report generated by " + Link + " e1efd0d fix with Claude:claude-opus-5-5_"
	if got != want {

...
func planCommentFooter(model string) string {
	return attribution.CommentFooter("Implementation plan generated by", "implement", model)
}
...
func (r *Runner) postPlanComment(w io.Writer, opts Options, owner, name string, number int, plan, model string) {
	...
	github.PostBestEffort(w, "implementation plan", fmt.Sprintf("issue #%d", number), func() (string, error) {
		return r.GitHub.AddIssueComment(owner, name, number, formatPlanComment(plan, model))
	})
}
...
func reportCommentFooter(model string) string {
	return attribution.CommentFooter("Implementation report generated by", "implement", model)
}
...
func (r *Runner) postReportComment(w io.Writer, opts Options, owner, name string, number int, report, model string) {
	...
	github.PostBestEffort(w, "implementation report", fmt.Sprintf("issue #%d", number), func() (string, error) {
		return r.GitHub.AddIssueComment(owner, name, number, formatReportComment(report, model))
	})
}
...
func progressNoteFooter(model string) string {
	return attribution.CommentFooter("Progress note recorded by", "implement", model)
}
...
func (r *Runner) postProgressNote(w io.Writer, opts Options, owner, name string, number int, output, model string) {
	...
	github.PostBestEffort(w, "progress note", fmt.Sprintf("issue #%d", number), func() (string, error) {
		return r.GitHub.AddIssueComment(owner, name, number, formatProgressNoteComment(output, number, model))
	})
}
...
func (r *Runner) postSimplifyComment(w io.Writer, owner, name string, number int, simplifyReport, model string) {
	github.PostBestEffort(w, "simplification report", fmt.Sprintf("issue #%d", number), func() (string, error) {
		return r.GitHub.AddIssueComment(owner, name, number, formatSimplifyComment(simplifyReport, model))
	})
}

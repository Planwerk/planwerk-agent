...
func analysisCommentFooter(model string) string {
	return attribution.CommentFooter("Rebase analysis generated by", "rebase", model)
}
...
func (r *Runner) postAnalysisComment(w io.Writer, opts Options, owner, repo string, number int, body, model string) {
	...
	github.PostBestEffort(w, "rebase analysis", fmt.Sprintf("PR #%d", number), func() (string, error) {
		return r.GitHub.AddPRComment(owner, repo, number, comment)
	})
}

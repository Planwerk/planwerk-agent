...
> Reviewed by [planwerk-agent](https://github.com/planwerk/planwerk-agent) vX.Y.Z with Claude:claude-opus-5-5
...
`with Claude:claude-opus-5-5`, not the alias passed via `--claude-model`. The
